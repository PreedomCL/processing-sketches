...
void setup() {
  ...
  objects.add(new PhysicsObject(10, 1000f, new PVector(800,300,300), new PVector(0,-1, 2), false));
  objects.add(new PhysicsObject(10, 1000f, new PVector(900,300,300), new PVector(0,-1, 2), false));
  objects.add(new PhysicsObject(10, 5000f, new PVector(-500,300,-300), new PVector(0,-1, -2), false));
...
void draw() {
  ...
  text(((mouseX/scale) - xOffset) + "," + ((mouseY/scale) - yOffset) + "," + (zOffset) + "|Scale: " + scale, mouseX, mouseY);
